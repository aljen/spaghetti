...
elseif (GCC OR CLANG)
  ...
  if (GCC)
    set(COMMON_FLAGS_CXX "-fdelete-null-pointer-checks -fstrict-aliasing -fipa-pure-const")
    set(COMMON_WARNINGS "-Wall -Wextra -Werror -Wnull-dereference -Wreturn-type -Wdouble-promotion")
    set(COMMON_WARNINGS "${COMMON_WARNINGS} -Wformat=2 -Wuninitialized -Winit-self -Wmissing-include-dirs")
  ...
  elseif (CLANG)
    ...
    set(COMMON_WARNINGS "${COMMON_WARNINGS} -Wno-missing-variable-declarations -Wno-float-equal -Wno-switch-enum")
    set(COMMON_WARNINGS "${COMMON_WARNINGS} -Wno-missing-prototypes -Wsuggest-override")
  endif ()
else ()
...
set(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE} ${COMMON_FLAGS_RELEASE} ${COMMON_WARNINGS} ${COMMON_DEFINITIONS_RELEASE}")
...
set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} ${COMMON_FLAGS_RELEASE} ${COMMON_WARNINGS} ${COMMON_DEFINITIONS_RELEASE}")
