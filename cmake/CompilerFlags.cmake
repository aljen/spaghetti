...
if (MSVC)
  ...
  set(COMMON_WARNINGS "/W4 /WX")
elseif (GCC OR CLANG)
  set(COMMON_FLAGS "-march=native -mtune=native -pipe -fvisibility=hidden -pedantic -fstack-protector -fPIC")
...
#set(FLAGS_COMMON "${FLAGS_COMMON} -Weverything -Werror -Wno-c++98-compat -Wno-padded -Wno-exit-time-destructors")
#set(FLAGS_COMMON "${FLAGS_COMMON} -Wno-weak-vtables")

set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${COMMON_FLAGS} ${COMMON_FLAGS_C} ${COMMON_DEFINITIONS}")
set(CMAKE_C_FLAGS_DEBUG " ${COMMON_FLAGS_DEBUG} ${COMMON_WARNINGS} ${COMMON_DEFINITIONS_DEBUG}")
set(CMAKE_C_FLAGS_RELEASE " ${COMMON_FLAGS_RELEASE} ${COMMON_DEFINITIONS_RELEASE}")

set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${COMMON_FLAGS} ${COMMON_FLAGS_CXX} ${COMMON_DEFINITIONS}")
set(CMAKE_CXX_FLAGS_DEBUG " ${COMMON_FLAGS_DEBUG} ${COMMON_WARNINGS} ${COMMON_DEFINITIONS_DEBUG}")
set(CMAKE_CXX_FLAGS_RELEASE " ${COMMON_FLAGS_RELEASE} ${COMMON_DEFINITIONS_RELEASE}")
